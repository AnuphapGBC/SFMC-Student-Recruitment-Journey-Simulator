...
| --- | --- |
| Project | SFMC Student Recruitment Journey Simulator â€” Personal Portfolio Project |
...
- AMPscript-style personalization;
...
| `email/program-event-invite.html` | AMPscript-style email implementation example |
...
The live build is available at [sfmc-student-journey.pekkychan.chatgpt.site](https://sfmc-student-journey.pekkychan.chatgpt.site). Repository visibility and hosted-site visibility should both be tested in a private browser before the project is shared with recruiters.
...
3. Store consent purpose, source, timestamp, jurisdiction, and evidenceâ€”not only current status.
...
**Licence:** MIT Â© 2026 Pek Chansatit